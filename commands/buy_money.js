...
const shopCatalogue = require("../shop/moneyCatalogue.json");
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("buy_money")
    .setDescription("Buy an item from the money shop.")
  ...
  async execute(interaction) {
    ...
    if (userProfile.money < item.price) {
